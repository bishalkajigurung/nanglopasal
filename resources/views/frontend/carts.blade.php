    ...
    <div class="bg-gray-50 py-8 md:py-12 min-h-screen">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                ...
                <a href="/"
                    class="mt-4 md:mt-0 inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-gray-300 hover:border-primary hover:text-primary transition">
                                    ...
                                    @foreach ($sellerCarts as $cart)
                                        ...
                                        <div class="p-6 flex flex-col md:flex-row gap-6 items-center">
                                            ...
                                            <a href="/product/{{ $product->id }}"
                                                class="w-28 h-28 flex-shrink-0 bg-gray-100 rounded-xl overflow-hidden">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="text-sm text-gray-500 mt-1">
                                                    {{ $variant->title ?? 'Default Variant' }}</p>
                                            ...
                                            <div class="flex flex-col items-end gap-4">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <p class="font-bold text-lg">NPR {{ number_format($subtotal, 2) }}
                                                    </p>
                                                </div>
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-2xl shadow-sm border p-6 sticky top-24">
                            ...
                            <div class="p-6 border-t border-gray-100">
                                <a href="{{ route('checkout', $sellerId) }}"
                                    class="flex items-center justify-center gap-2 w-full py-3 rounded-xl text-white font-semibold transition hover:opacity-90 shadow-md"
